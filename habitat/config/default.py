...
_C.TASK.MAP_SENSOR = CN()
_C.TASK.MAP_SENSOR.TYPE = "MapSensor"
...
_C.TASK.SEEN_MAP = CN()
_C.TASK.SEEN_MAP.TYPE = "SeenMap"
_C.TASK.SEEN_MAP.VISIBILITY_DIST = 2.0
_C.TASK.SEEN_MAP.FOV = 80
# PSPL MEASUREMENT
...
_C.TASK.TOP_DOWN_MAP.MAP_RESOLUTION = 15000
...
_C.TASK.TOP_DOWN_MAP.FOG_OF_WAR.DRAW = False
...
_C.TASK.TRAJ_METRICS = CN()
_C.TASK.TRAJ_METRICS.TYPE = "TrajMetrics"
