...
MAP_TARGET_POINT_INDICATOR_RED = 6
MAP_TARGET_POINT_INDICATOR_GREEN = 10
MAP_TARGET_POINT_INDICATOR_BLUE = 11
MAP_TARGET_POINT_INDICATOR_YELLOW = 12
MAP_TARGET_POINT_INDICATOR_WHITE = 13
MAP_TARGET_POINT_INDICATOR_PINK = 14
MAP_TARGET_POINT_INDICATOR_BLACK = 15
MAP_TARGET_POINT_INDICATOR_CYAN = 16
MAP_AGENT_PATH_INDICATOR = 17
MAP_SOURCE_POINT_INSIDE_INDICATOR = 18
...
TOP_DOWN_MAP_COLORS[MAP_SOURCE_POINT_INDICATOR] = [14, 127, 255]  # Orange
TOP_DOWN_MAP_COLORS[MAP_TARGET_POINT_INDICATOR_RED] = [255, 0, 0]  # Red
TOP_DOWN_MAP_COLORS[MAP_TARGET_POINT_INDICATOR_GREEN] = [0, 255, 0]  # Green
TOP_DOWN_MAP_COLORS[MAP_TARGET_POINT_INDICATOR_BLUE] = [0, 0, 255]  # Blue
TOP_DOWN_MAP_COLORS[MAP_TARGET_POINT_INDICATOR_YELLOW] = [255, 255, 51]  # Yellow
TOP_DOWN_MAP_COLORS[MAP_TARGET_POINT_INDICATOR_WHITE] = [255, 255, 255]  # White
TOP_DOWN_MAP_COLORS[MAP_TARGET_POINT_INDICATOR_PINK] = [255, 51, 255]  # Pink
TOP_DOWN_MAP_COLORS[MAP_TARGET_POINT_INDICATOR_BLACK] = [0, 0, 0]  # Black
TOP_DOWN_MAP_COLORS[MAP_TARGET_POINT_INDICATOR_CYAN] = [0, 255, 255]  # Cyan
TOP_DOWN_MAP_COLORS[MAP_SHORTEST_PATH_COLOR] = [44, 160, 44]  # Green
...
TOP_DOWN_MAP_COLORS[MAP_AGENT_PATH_INDICATOR] =  [14, 127, 255]
TOP_DOWN_MAP_COLORS[MAP_SOURCE_POINT_INSIDE_INDICATOR] = [150, 150, 150]
